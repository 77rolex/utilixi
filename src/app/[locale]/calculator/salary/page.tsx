...
const CONTENT: Record<string, {
  ...
  en: {
    ...
    faqs: [
      ...
      { q: 'How do I convert hourly rate to annual salary?', a: 'Annual salary = Hourly rate × Hours per week × 52 weeks. For example, £25/hour × 40 hours/week × 52 = £52,000 gross annual. Then apply the net salary calculation for your country. Most countries also have pro-rata adjustments for part-time work.' },
  ...
  ru: {
    ...
    faqs: [
      ...
      { q: 'Как пересчитать почасовую ставку в годовой доход?', a: 'Годовой доход = Часовая ставка × Часов в неделю × 52. Например, 500 ₽/час × 40 ч × 52 = 1 040 000 ₽ брутто в год. Далее примените калькулятор для вашей страны.' },
  ...
  uk: {
    ...
    faqs: [
      ...
      { q: 'Як перерахувати погодинну ставку в річний дохід?', a: 'Річний дохід = Годинна ставка × Годин на тиждень × 52. Наприклад, 200 грн/год × 40 год × 52 = 416 000 грн брутто на рік. Далі застосуйте калькулятор для вашої країни.' },
  ...
  fr: {
    ...
    faqs: [
      ...
      { q: 'Comment convertir un taux horaire en salaire annuel ?', a: 'Salaire annuel = Taux horaire × Heures/semaine × 52. Exemple : 25 €/h × 35 h × 52 = 45 500 € brut annuel. Divisez par 12 pour le mensuel brut. Appliquez ensuite le calculateur pour votre pays.' },
  ...
  lt: {
    ...
    faqs: [
      ...
      { q: 'Kaip konvertuoti valandinį tarifą į metines pajamas?', a: 'Metinės pajamos = Valandinis tarifas × Valandų per savaitę × 52. Pvz.: 15 €/val. × 40 val. × 52 = 31 200 € bruto per metus. Tada pritaikykite skaičiuotuvą Lietuvai.' },
