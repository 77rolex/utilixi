...
const META: Record<string, { title: string; description: string; h1: string }> = {
  ...
  ru: {
    title: 'Калькулятор макросов — белки, жиры и углеводы по цели',
    description: 'Бесплатный калькулятор макросов. Получите суточные нормы белков, жиров и углеводов исходя из калорийности и цели: похудение, поддержание веса или набор массы.',
    h1: 'Калькулятор макросов',
  },
  uk: {
    title: 'Калькулятор макросів — білки, жири і вуглеводи за ціллю',
    description: 'Безкоштовний калькулятор макросів. Отримайте добові норми білків, жирів і вуглеводів виходячи з калорійності та мети: схуднення, підтримка ваги або набір маси.',
    h1: 'Калькулятор макросів',
  },
  fr: {
