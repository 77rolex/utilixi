...
const META: Record<string, { title: string; description: string; h1: string }> = {
  ...
  uk: {
    title: 'Калькулятор ПДВ онлайн — розрахунок ПДВ безкоштовно',
    description: 'Безкоштовний калькулятор ПДВ онлайн. Додайте ПДВ до суми без ПДВ або виділіть ПДВ із суми з ПДВ. Ставки 20+ країн: Україна (20%), Польща (23%), Литва (21%) та інші.',
    h1: 'Калькулятор ПДВ',
  },
  fr: {
