...
const META: Record<string, { title: string; description: string; h1: string }> = {
  ...
  ru: {
    title: 'Компенсация за задержку рейса — EU261/2004 онлайн',
    description: 'Проверьте право на компенсацию за задержку рейса по Регламенту ЕС 261/2004. Узнайте сумму компенсации — €250, €400 или €600 — в зависимости от дальности и задержки. Бесплатный расчёт онлайн.',
    h1: 'Калькулятор компенсации за задержку рейса',
  },
  uk: {
