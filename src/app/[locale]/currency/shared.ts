export type LangKey = 'en' | 'ru' | 'uk' | 'fr' | 'lt';

export const CURRENCY_NAMES: Record<string, Partial<Record<LangKey, string>>> = {
  ...
  AWG: { en: 'Aruban Florin', ru: 'Арубанский флорин', uk: 'Арубанський флорин', fr: 'Florin arubais', lt: 'Arubos florinas' },
  ...
  BMD: { en: 'Bermudian Dollar', ru: 'Бермудский доллар', uk: 'Бермудський долар', fr: 'Dollar des Bermudes', lt: 'Bermudų doleris' },
  ...
  BTN: { en: 'Bhutanese Ngultrum', ru: 'Бутанский нгултрум', uk: 'Бутанський нгултрум', fr: 'Ngultrum bhoutanais', lt: 'Butano ngultrumas' },
  ...
  CDF: { en: 'Congolese Franc', ru: 'Конголезский франк', uk: 'Конголезький франк', fr: 'Franc congolais', lt: 'Kongo frankas' },
  CHF: { en: 'Swiss Franc', ru: 'Швейцарский франк', uk: 'Швейцарський франк', fr: 'Franc suisse', lt: 'Šveicarijos frankas' },
  CLF: { en: 'Chilean Unit of Account (UF)', ru: 'Чилийская единица расчёта (UF)', uk: 'Чилійська розрахункова одиниця (UF)', fr: 'Unité de compte chilienne (UF)', lt: 'Čilės atsiskaitymo vienetas (UF)' },
  ...
  CUP: { en: 'Cuban Peso', ru: 'Кубинский песо', uk: 'Кубинський песо', fr: 'Peso cubain', lt: 'Kubos pesas' },
  CVE: { en: 'Cape Verdean Escudo', ru: 'Эскудо Кабо-Верде', uk: 'Ескудо Кабо-Верде', fr: 'Escudo cap-verdien', lt: 'Žaliojo Kyšulio eskudas' },
  ...
  GNF: { en: 'Guinean Franc', ru: 'Гвинейский франк', uk: 'Гвінейський франк', fr: 'Franc guinéen', lt: 'Gvinėjos frankas' },
  ...
  LSL: { en: 'Lesotho Loti', ru: 'Лесотский лоти', uk: 'Лесотський лоті', fr: 'Loti du Lesotho', lt: 'Lesoto lotis' },
